...
| Месячная аудитория, MAU | Дневная аудитория, DAU | Средний размер хранилища пользователя, шт. | Средний размер хранилища пользователя, Гб. | Среднее кол-во действий пользователя о типам в день |
| :---: | :---: | :---: | :---: | :---: |
| 640 млн | 45 | 5 | 4 | 3 |
